...
bleed_core = {"name": "AssautlRifle", "type": "Melee", "base_damage": 5, "speed": 4, "weight": 1}
bleed_attachment = {"name": "Barbed Wire", "bonus_damage": 4, "accuracy": -3, "weight": 2, "type": "melee"}
...
stun_core = {"name": "Cane", "type": "Melee", "base_damage": 6, "speed": 4, "weight": 1}
stun_attachment = {"name": "Barbed Wire", "bonus_damage": 3, "accuracy": 10, "weight": 2, "type": "universal"}
stun_grip = {"name": "Lead", "stability": 5, "bounce": 0}
stun_enchant = {"name": "Frost", "element": "ice", "power": 2, "status_effect": "chill"}
